...
namespace CompanyEmployees.API.Controllers
{
    ...
    public class EmployeesController : ControllerBase
    {
        ...
        [HttpPut("{id:guid}")]
        public async Task<IActionResult> UpdateEmployeeForCompany(Guid companyId, Guid id, [FromBody] EmployeeForUpdateDto employees)
        {
           ...
           await  _service.EmployeeService.UpdateEmployeeForCompanyAsync(companyId, id, employees, compTrackChanges: false, empTrackChanges: true);
